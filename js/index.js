...
function refreshLibrary() {
  ...
  panelbody.innerHTML = visibleApps.map((app,idx) => {
    ...
    <div class="tile-content">
      ...
      <a href="https://github.com/gerardwr/P8apps/tree/master/apps/${app.id}" target="_blank" class="link-github"><img src="img/github-icon-sml.png" alt="See the code on GitHub"/></a>
    </div>
